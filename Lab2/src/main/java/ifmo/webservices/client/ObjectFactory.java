...
public class ObjectFactory {
    ...
    private final static QName _LoadImageResponse_QNAME = new QName("http://webservices.ifmo/", "loadImageResponse");
    ...
    private final static QName _LoadImage_QNAME = new QName("http://webservices.ifmo/", "loadImage");
    ...
    /**
     * Create an instance of {@link LoadImage }
     * 
     */
     ...
     * 
     */
    public BookFieldValue createBookFieldValue() {
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link LoadImageResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://webservices.ifmo/", name = "loadImageResponse")
    public JAXBElement<LoadImageResponse> createLoadImageResponse(LoadImageResponse value) {
        return new JAXBElement<LoadImageResponse>(_LoadImageResponse_QNAME, LoadImageResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link LoadImage }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://webservices.ifmo/", name = "loadImage")
    public JAXBElement<LoadImage> createLoadImage(LoadImage value) {
        return new JAXBElement<LoadImage>(_LoadImage_QNAME, LoadImage.class, null, value);
    }
