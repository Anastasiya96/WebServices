 ...
 * "portable". URLs are set in uddi2.xml
 *
 */
public class SimplePublishPortable {
        ...
        public SimplePublishPortable() {
                try {
                        ...
                        UDDIClient uddiClient = new UDDIClient("META-INF/uddi2.xml");
                        // a UddiClient can be a client to multiple UDDI nodes, so 
                        // supply the nodeName (defined in your uddi2.xml.
                        // The transport can be WS, inVM, RMI etc which is defined in the uddi2.xml
